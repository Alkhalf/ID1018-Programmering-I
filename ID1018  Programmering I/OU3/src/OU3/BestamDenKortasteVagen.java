...
public class BestamDenKortasteVagen {
	public static void main (String []args)
	{
		...
		System.out.println("Ange längdar från mellanstatione X i zonen 1 till varje mellanstation i zonen 2");
		for ( int i=1; i<= m; i++ )
		{
			double ai = a[i];
			a[i] = in.nextDouble();
		...
		System.out.println("Ange längdar från varje mellan station i zonen 2 till varje mellanstation i zonen 3");
		for ( int i=1; i <= m; i++ )
		{
			for (int j = 1; j <= n; j++)
			{	
		...
		//får mellanstationerna som kortaste väggen går igenom de retunerad från 
		//klassen DenKortasteVagen.mellanstationerna och sedan skriva ut den
		//a[mellanstationer[0]] motsvarar den mellan station a s
